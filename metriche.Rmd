...
```{r plot foto aeree, echo=FALSE, fig.ext='png',fig.height=3 ,fig.width=12, message=FALSE, warning=FALSE}
...
```{r plot heatmap resistenza, echo=FALSE, fig.ext='png', fig.width=8 ,fig.height=10, message=FALSE, warning=FALSE}
...
```{r plot heatmap assorbimento, echo=FALSE, fig.ext='png', fig.width=8 ,fig.height=10, message=FALSE, warning=FALSE}
...
```{r plot heatmap dispersione, echo=FALSE, fig.ext='png',fig.width=8 ,fig.height=10, message=FALSE, warning=FALSE}
...
```{r plot heatmap mortalita, echo=FALSE, fig.ext='png',fig.width=8 ,fig.height=10, message=FALSE, warning=FALSE}
