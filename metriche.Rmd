...
```{r plot foto aeree, echo=FALSE, fig.ext='png', fig.width=20, message=FALSE, warning=FALSE}
...
```{r plot heatmap resistenza, echo=FALSE, fig.ext='png', fig.height=10, message=FALSE, warning=FALSE}
ridge_resistance + plot_resistance_dc + plot_annotation(title="resistenza")
```
...
```{r plot heatmap assorbimento, echo=FALSE, fig.ext='png', fig.height=10, message=FALSE, warning=FALSE}
ridge_assorbance + plot_absorbance_dc + plot_annotation(title="assorbimento")
```
...
```{r plot heatmap dispersione, echo=FALSE, fig.ext='png', fig.height=10, message=FALSE, warning=FALSE}
ridge_dispersion + plot_dispersion_dc + plot_annotation(title="dispersione")
```
...
```{r plot heatmap mortalita, echo=FALSE, fig.ext='png', fig.height=10, message=FALSE, warning=FALSE}
ridge_mortality + plot_mortality_dc + plot_annotation(title="mortalità")
```