...
L'elaborazione del paesaggio per ogni azienda viene sviluppata nella cartella "raster", nello script [raster.R](raster/raster.R), che prende una fotointerpretazione e sviluppa l'elaborazione creando vari raster geotiff divisi in cartelle secondo la metrica.
